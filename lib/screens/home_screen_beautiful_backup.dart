...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildMainContent(List<Category> categories,
    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        slivers: [
          _buildAppBar(),
          _buildPromotionBanner(promotions),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'สินค้าที่ผ่านการตรวจสอบและอนุมัติจากแอดมิน',
                          style: TextStyle(
                            fontSize: 14,
            ...
            const SizedBox(height: 16),
            // สร้างส่วนแสดงสินค้าแต่ละระดับ EcoLevel
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${levelProducts.length} รายการ | ระดับความเป็นมิตรต่อสิ่งแวดล้อม ${_getEcoRangeText(level)}',
                                style: TextStyle(
                                  fontSize: 14,
  ...
  String _getEcoRangeText(EcoLevel level) {
    switch (level) {
      case EcoLevel.basic:
        return '0-25%';
